...
const stocks = [
  ...
  { ticker: 'ELET6', name: 'Eletrobras', sector: 'Energia', category: 'perene' },
  { ticker: 'ENBR3', name: 'Energia Brasil', sector: 'Energia', category: 'perene' },
  { ticker: 'TRPL4', name: 'Transmissão Paulista', sector: 'Energia', category: 'perene' },
  { ticker: 'VIVT3', name: 'Vivo', sector: 'Telecom', category: 'perene' },
  { ticker: 'TIMS3', name: 'TIM', sector: 'Telecom', category: 'perene' },
  { ticker: 'COGN3', name: 'Cogna', sector: 'Educação', category: 'ciclica' },
  { ticker: 'YDUQ3', name: 'Yduqs', sector: 'Educação', category: 'ciclica' }
];
...
function searchStocks(query) {
  ...
  return stocks.filter(s => {
    ...
    return ticker.includes(query) || name.includes(query) || sector.includes(query) || category.includes(query);
  });
}
...
// Função para realizar busca quando o usuário digita
