...
function _desenharGrafico(index, anos, preco, media) {
  ...
  function draw(){
    ...
    ctx.font='8.5px Space Mono,monospace'; ctx.fillStyle='rgba(100,116,139,0.5)';
...
function _desenharGraficoModal(anos, preco, media) {
  ...
  function draw() {
    ...
    ctx.font="9px 'Space Mono',monospace"; ctx.fillStyle='rgba(100,116,139,0.5)';
    ...
    if (prog >= 1) {
      ...
      ctx.fillStyle='#3b82f6'; ctx.font="bold 12px 'Space Mono',monospace";
