...
function activateFilterBtn(filter) {
  if (modoTop) closeTopMode();  // ← adiciona essa linha
      ...
      <div class="stock-card ${borderClass}" data-index="${index}">
        <div class="stock-header">
          ...
          <div class="discount-badge" style="
            background: ${cls === 'div' ? 'rgba(16,185,129,0.2)' : cls === 'pat' ? 'rgba(139,92,246,0.2)' : 'rgba(245,158,11,0.2)'};
            color: ${cls === 'div' ? '#10b981' : cls === 'pat' ? '#a78bfa' : '#f59e0b'};
          ">${badgeText}</div>
        </div>
