...
const stocks = [
  ...
  { ticker: 'CPLE3', name: 'Copel', sector: 'Energia', category: 'perene' }, // ✅ Corrigido CPLE6→CPLE3
  { ticker: 'CMIG4', name: 'Cemig', sector: 'Energia', category: 'perene' },
  { ticker: 'EQTL3', name: 'Equatorial', sector: 'Energia', category: 'perene' },
  { ticker: 'ELET6', name: 'Eletrobras', sector: 'Energia', category: 'perene' }, // ✅ Corrigido ELET3→ELET6
  { ticker: 'TRPL3', name: 'Tran Paulist', sector: 'Energia', category: 'perene' }, // ✅ Corrigido TRPL4→TRPL3
